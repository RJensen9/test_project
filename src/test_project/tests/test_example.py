...
# isort: off
from test_project.example import ExampleClass
# isort: on
...
class TestExample:
    ...
    def setupClass(self):
        ...
        E.g. initialise any variables or resources used by all test functions.
        """
    ...
    def teardownClass(self):
        """
        This is run only once after all the test functions in this class are complete.
        """
